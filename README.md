# Word-Guess-Game
HW-3
https://gpiercelusk.github.io/Word-Guess-Game/
...
1. Create a new GitHub repo called `Word Guess Game` , in accordance with the assignment you choose to complete. Then, clone it to your computer.
